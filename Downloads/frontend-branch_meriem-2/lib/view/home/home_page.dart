  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: CurvedNavigationBar(
        ...
        items: const [
    Icon(Icons.dashboard, size: 30, color: Colors.white), // Accueil / Dashboard
    Icon(Icons.event, size: 30, color: Colors.white), // Rendez-vous
    Icon(Icons.accessibility_new, size: 30, color: Colors.white), // Corps humain
    Icon(Icons.monitor_heart, size: 30, color: Colors.white), // Suivi de santé
    Icon(Icons.local_pharmacy, size: 30, color: Colors.white), // Médicaments
  ],
      ),
    );
  }
...
class _DashboardPageState extends State<DashboardPage> {
  ...
  Widget _heartRateCard(bool isDarkMode) =>
      _infoCard("Heart Rate", Icons.monitor_heart_outlined, "75 bpm", isDarkMode);
  Widget _medicationCard(bool isDarkMode) =>
      _infoCard("Medication", Icons.medication_outlined, "80% Taken", isDarkMode);
  Widget _dailyCaresCard(bool isDarkMode) =>
      _infoCard("Daily Care", Icons.check_circle_outline, "Completed: 80%", isDarkMode);
