...
class _MemoryMatchPageState extends State<MemoryMatchPage> {
  final List<String> _cards = List.generate(8, (index) => (index + 1).toString())
    ..addAll(List.generate(8, (index) => (index + 1).toString()))
    ..shuffle(Random());
  final List<bool> _cardFlips = List.generate(16, (index) => false);
  final List<int> _cardValues = List.generate(16, (index) => 0);
  int _matchedCount = 0;
  int _score = 0;
  int _moves = 0;
