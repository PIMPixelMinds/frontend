...
class _HomePageState extends State<HomePage> {
 ...
 final GlobalKey _tutorialKey = GlobalKey(); // ✅ Key for tutorial target
 final GlobalKey _gestureKey = GlobalKey(); // ✅ Key for GestureDetector

 @override
 void initState() {
   super.initState();
   WidgetsBinding.instance.addPostFrameCallback((_) {
     _showTutorial(); // Show walkthrough every time
   });
 }

 void _showTutorial() {
   print("🚀 Walkthrough is triggered!"); // Debugging line
 ...
 List<TargetFocus> _createTargets() {
   return [
     TargetFocus(
       identify: "swipe_hint",
       keyTarget: _tutorialKey, // ✅ Now correctly defined
         ...
         TargetContent(
           ...
           child: Column(
             ...
             children: [
               ...
               const Text(
                 "You can swipe left to navigate to the News Page.",
     ...
     body: Builder(
       builder: (context) {
         return GestureDetector(
           key: _gestureKey, // ✅ Separate key for GestureDetector
           ...
           child: Column(
             children: [
               Container(
                 key: _tutorialKey, // ✅ Attach this key to a visible widget
