class ApiConstants {
  ...
  static const String addAppointmentEndpoint = "$baseUrl/appointment/addAppointment";
  static const String updateAppointmentEndpoint = "$baseUrl/appointment/updateAppointment";
  static const String cancelAppointmentEndpoint = "$baseUrl/appointment/cancelAppointment";
  static const String displayAppointmentEndpoint = "$baseUrl/appointment/displayAppointment";
  static const String updateFcmTokenEndpoint = "$baseUrl/appointment/updateFcmToken";
