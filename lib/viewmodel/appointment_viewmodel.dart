...
class AppointmentViewModel extends ChangeNotifier {
  ...
  Future<void> updateAppointment(String name, { required String newFullName, required String newDate, required String newPhone }) async {
    isLoading = true;
    notifyListeners();
    try {
      await _repository.updateAppointment(name, newFullName: newFullName, newDate: newDate, newPhone: newPhone);
      errorMessage = null;
    } catch (e) {
      errorMessage = e.toString();
    } finally {
